...
CREATE TABLE public.moon (
    ...
    name character varying(255) NOT NULL,
    satellite_id character varying,
...
ALTER SEQUENCE public.solarsystem_solarysystem_id_seq OWNED BY public.solarsystem.solarysystem_id;
...
--
-- Name: solarsystem solarysystem_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.solarsystem ALTER COLUMN solarysystem_id SET DEFAULT nextval('public.solarsystem_solarysystem_id_seq'::regclass);
...
INSERT INTO public.galaxy VALUES (2, NULL, NULL, 'canis');
INSERT INTO public.galaxy VALUES (3, NULL, NULL, 'virgo_a');
INSERT INTO public.galaxy VALUES (4, NULL, NULL, ' Milky_way');
INSERT INTO public.galaxy VALUES (5, NULL, NULL, 'cygnus_a');
INSERT INTO public.galaxy VALUES (6, NULL, NULL, ' maffei');
...
SELECT pg_catalog.setval('public.solarsystem_solarysystem_id_seq', 1, false);
...
--
-- Name: moon moon_satellite_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_satellite_id_key UNIQUE (satellite_id);
